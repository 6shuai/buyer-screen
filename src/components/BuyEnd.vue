    ...
    >
        ...
        <div class="goods_detail">
            ...
            <div class="goods_detail_right">
                ...
                <p class="goods_del_price base_color">￥{{ priceFormat(data.marketValue).int }}<span class="decimals">{{ priceFormat(data.marketValue).decimals }}</span></p>
            </div>
        </div>
        ...
        onMounted(() => {
            setTimeout(() => {
                ...
                if(currentGoodsIndex != goodsListData.length - 1){
                    ...
                    playJxmsSounds.value('./voice/03_01.mp3')   
                }else{
                    //后面没有宝贝
